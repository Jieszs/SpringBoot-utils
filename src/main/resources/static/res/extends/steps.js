    ...
    var obj = {
        ...
        make: function (data, ele, current) {
            ...
            for (var i = 0; i < data_length; i++) {
                ...
                temp += '<label class="step-item-label">'+ data[i].title + '</label><div class="step-item-main"><div class="step-item-main-title"></div><div class="step-item-main-desc">' + data[i].desc + '</div></div></div>';
